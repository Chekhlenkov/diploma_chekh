...
class TestCreateGoalCategoryView:
    ...
    """ Пользователь не может создать цель доске, если он не участник """
    ...
    """ Читатель не может создать цель на чужой доске """
    ...
    """ Владелец или писатель может создать доску на стенде """
    ...
    """ Создание цели с удаленной категорией"""
    ...
    """ Создание цели с несуществующей категорией"""
